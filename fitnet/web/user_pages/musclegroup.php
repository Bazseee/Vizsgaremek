...
<head>
    ...
    <link rel="stylesheet" href="../css/musclegroup.css">
    <link rel="stylesheet" href="../css/musclegroup-responsive.css">
    <title>FitNet - Musclegroup selector</title>
    <style>
...
<body class="overflow-x-hidden">
    ...
    <!--PIROS BLOB-->
    <h1
        class="text-center mb-4 text-xl font-extrabold leading-none tracking-tight text-red-600 md:text-xl lg:text-2xl dark:text-white mt-8">
        Muscle Group Selector</h1>

    <div class="muscle-groups">
        <div class="muscle-groups-input">
            <h2>Arms</h2>

            <input type="checkbox" class="biceps muscles-helper" id="biceps"> <label for="biceps"><a
                    href="biceps.php">Biceps</a></label>
            <input type="checkbox" class="deltoids muscles-helper" id="deltoids"> <label for="deltoids"><a
                    href="shoulder.php">Deltoids</a></label>
            <input type="checkbox" class="forearms muscles-helper" id="forearms"> <label for="forearms"><a
                    href="forearms.php">Forearms</a></label>
            <input type="checkbox" class="triceps muscles-helper" id="triceps"> <label for="triceps"><a
                    href="triceps.php">Triceps</a></label>
            <h2>Back</h2>
            <input type="checkbox" class="trapezius muscles-helper" id="trapezius"> <label for="trapezius"><a
                    href="trapezius.php">Trapezius</a></label>
            <input type="checkbox" class="lats muscles-helper" id="lats"> <label for="lats"><a
                    href="lats.php">Lats</a></label>
            <h2>Core</h2>
            <input type="checkbox" class="abs muscles-helper" id="abs"> <label for="abs"><a
                    href="abs.php">Abs</a></label>
            <input type="checkbox" class="obliques muscles-helper" id="obliques"> <label for="obliques"><a
                    href="obliques.php">Obliques</a></label>
            <input type="checkbox" class="pectorals muscles-helper" id="pectorals"> <label for="pectorals"><a
                    href="pectorals.php">Pectorals</a></label>
            <h2>Legs</h2>
            <input type="checkbox" class="adductors muscles-helper" id="adductors"> <label for="adductors"><a
                    href="adductors.php">Adductors</a></label>
            <input type="checkbox" class="calves muscles-helper" id="calves"> <label for="calves"><a
                    href="calves.php">Calves</a></label>
            <input type="checkbox" class="hamstrings muscles-helper" id="hamstrings"> <label for="hamstrings"><a
                    href="hamstrings.php">Hamstrings</a></label>
            <input type="checkbox" class="glutes muscles-helper" id="glutes"> <label for="glutes"><a
                    href="glutes.php">Glutes</a></label>
            <input type="checkbox" class="quads muscles-helper" id="quads"> <label for="quads"><a
                    href="quads.php">Quads</a></label>
        </div>
        <svg width="100%" height="100%" viewBox="0 0 176 207" version="1.1" xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink" xml:space="preserve"
            style="fill-rule:evenodd;clip-rule:evenodd;stroke-linejoin:round;stroke-miterlimit:1.41421;">
            <rect id="Artboard1" x="0" y="0" width="175.551" height="206.785" style="fill:none;" />
            <g id="Back-Muscles">
                <g>
                    <a href="trapezius.php">
                        <g id="Trapezius">
                            <g>
                                <path
